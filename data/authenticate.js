export const authenticateData = {
  ...
  welcome: { text: 'Welcome to Mastodon, ' },
  next: { text: "You're in! So What's next?" },
  subHeading: {
    text: 'Please check your email and click the Mastodon confirmation link. Once you get to this message - Your email address has been successfully confirmed. - come back to this window to continue through the steps.',
  },
